<template>
  <div ref="slider" class="front-projects-slider swiper">
    <div class="swiper-wrapper">
      <div
        v-for="(slide, index) of slides"
        :key="'front-projects-' + index"
        class="front-projects-slider__slide swiper-slide"
      >
        <div
          class="front-projects-slider__img"
          v-html="
            isMobile
              ? slide.field_image_adaptive[0].markup
              : slide.field_image[0].markup
          "
        />
    ...
    <div class="front-projects-slider__pagination-wrap">
      ...
      <div class="front-projects-slider__pagination"/>
    </div>
  </div>
</template>
